output "role_arn" {
  description = "Role used by Sysdig Platform for Agentless Lambda Scanning"
...
output "validate_deploy_global_resources" {
  ...
  precondition {
    ...
    error_message = "Please provide role_name or set deploy_global_resources set to false."
  }
  precondition {
