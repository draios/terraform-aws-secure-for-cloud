...
| <a name="input_policy_arn"></a> [policy\_arn](#input\_policy\_arn) | (Optional) IAM policy created for event-bridge. If already created value is needed to be passed | `string` | `""` | no |
| <a name="input_policy_document_json"></a> [policy\_document\_json](#input\_policy\_document\_json) | (Optional) IAM policy document created for event-bridge. If already created value is needed to be passed | `string` | `""` | no |
...
| Name | Description |
|------|-------------|
| <a name="output_policy_arn"></a> [policy\_arn](#output\_policy\_arn) | ARN of cspm role |
| <a name="output_policy_document_json"></a> [policy\_document\_json](#output\_policy\_document\_json) | ARN of cspm role |
